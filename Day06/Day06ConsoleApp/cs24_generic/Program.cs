...
{
    #region < 일반화 클래스 >
    class MyArray<T> where T : class // 일반화 클래스 // where T class 사용할 타입은 무조건 클래스 타입이여햐 한다.
    {
        T[] array;
    }
