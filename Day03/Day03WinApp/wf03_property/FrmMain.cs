...
namespace wf03_property
{
    public partial class FrmMain : Form
    {
        ...
        {
            GbxMain.Text = "컨트롤 학습";
            var fonts = FontFamily.Families.ToList(); // 내  폰트이름 가져오기
        ...
        private void BtnMsgBoxx_Click(object sender, EventArgs e)
        {
            //MessageBox.Show(TxtResult.Text); // 기본
            //MessageBox.Show(TxtResult.Text, caption: "메시지 창"); // 캡션 사용방법
            //MessageBox.Show(TxtResult.Text, "메시지 창", MessageBoxButtons.YesNoCancel); // 버튼 추가 
            //MessageBox.Show(TxtResult.Text, "메시지 창", 
        ...
        private void BtnAddChild_Click(object sender, EventArgs e)
        {
            if (TrvDummy.SelectedNode != null)
            {
                ...
                TrvDummy.SelectedNode.Expand(); // 트린노드 하위것 펼겨주기 <-> 반대 .Collapse
                TreeToList();
            }
        }
        void TreeToList()
        {
            LsvDummy.Items.Clear(); // 리스트뷰,
