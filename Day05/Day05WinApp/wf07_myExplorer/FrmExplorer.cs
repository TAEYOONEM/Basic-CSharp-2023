    ...
    public partial class FrmExplorer : Form
    {
        ...
        private void SetLsvFolder(string fullPath)
        {
            try
            {
                ...
                int fileCount = dirCount; // 이전 카운트 승계
            ...
            {
                MessageBox.Show("리스트 뷰 오류 발생!", "오류", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
